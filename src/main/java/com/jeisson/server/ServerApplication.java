...
public class ServerApplication {
	...
	CommandLineRunner run(ServerRepository serverRepository){
		return args -> {
			...
			serverRepository.save(new Server(null, "192.168.1.102", "Fedora Linux", "16 GB", "Dell Tower","http://localhost:8080/server/image/server2.png", SERVER_DOWN));
